  ...
  return (
    <div className="header">
      ...
      <nav className="bg-white px-6 py-[10px] flex items-center justify-between shadow-sm">
        <a id="nav-toggle" href="#" className="text-gray-800">
        ...
        <ul className="flex ml-auto items-center">
          <li className="dropdown stopevent mr-2">
            <a className="text-gray-600" href="#" role="button" id="dropdownNotification">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
          ...
          <li className="dropdown ml-2">
            <a className="rounded-full" href="#" role="button" id="dropdownUser">
              <div className="w-10 h-10 relative">
                <img alt="avatar" src="@@webRoot/assets/images/avatar/avatar-1.jpg" className="rounded-full" />
